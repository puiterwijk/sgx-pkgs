...
CXXFLAGS="-Wno-error=implicit -Wno-error=conversion -Wno-error=shadow -Wno-error=float-equal -Wno-error=redundant-decls -Wno-error=deprecated-copy" make psw_install_pkg DEBUG=1
